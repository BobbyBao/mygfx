...
namespace mygfx {
    ...
    static TinyImageFormat_DXGI_FORMAT GetDxgiFormat(DDS_PIXELFORMAT pixelFmt)
    {
        if (pixelFmt.flags & 0x00000004)   //DDPF_FOURCC
        {
            ...
            case '1TXD':         return TIF_DXGI_FORMAT_BC1_UNORM;
            case '3TXD':         return TIF_DXGI_FORMAT_BC2_UNORM;
            case '5TXD':         return TIF_DXGI_FORMAT_BC3_UNORM;
            case 'U4CB':         return TIF_DXGI_FORMAT_BC4_UNORM;
            case 'A4CB':         return TIF_DXGI_FORMAT_BC4_SNORM;
            case '2ITA':         return TIF_DXGI_FORMAT_BC5_UNORM;
            case 'S5CB':         return TIF_DXGI_FORMAT_BC5_SNORM;
            case 'GBGR':         return TIF_DXGI_FORMAT_R8G8_B8G8_UNORM;
            case 'BGRG':         return TIF_DXGI_FORMAT_G8R8_G8B8_UNORM;
            case 36:             return TIF_DXGI_FORMAT_R16G16B16A16_UNORM;
            case 110:            return TIF_DXGI_FORMAT_R16G16B16A16_SNORM;
            case 111:            return TIF_DXGI_FORMAT_R16_FLOAT;
            case 112:            return TIF_DXGI_FORMAT_R16G16_FLOAT;
            case 113:            return TIF_DXGI_FORMAT_R16G16B16A16_FLOAT;
            case 114:            return TIF_DXGI_FORMAT_R32_FLOAT;
            case 115:            return TIF_DXGI_FORMAT_R32G32_FLOAT;
            case 116:            return TIF_DXGI_FORMAT_R32G32B32A32_FLOAT;
            default:             return TIF_DXGI_FORMAT_UNKNOWN;
            }
        } else {
            switch (pixelFmt.bitMaskR) {
            case 0xff:        return TIF_DXGI_FORMAT_R8G8B8A8_UNORM;
            case 0x00ff0000:  return TIF_DXGI_FORMAT_B8G8R8A8_UNORM;
            case 0xffff:      return TIF_DXGI_FORMAT_R16G16_UNORM;
            case 0x3ff:       return TIF_DXGI_FORMAT_R10G10B10A2_UNORM;
            case 0x7c00:      return TIF_DXGI_FORMAT_B5G5R5A1_UNORM;
            case 0xf800:      return TIF_DXGI_FORMAT_B5G6R5_UNORM;
            case 0:           return TIF_DXGI_FORMAT_A8_UNORM;
            default:          return TIF_DXGI_FORMAT_UNKNOWN;
            };
        }
    }
	...
	static TinyImageFormat_DXGI_FORMAT GetSrgbFormat(TinyImageFormat_DXGI_FORMAT pixelFmt) {
		switch (pixelFmt)
		{
		case TIF_DXGI_FORMAT_BC1_UNORM: return TIF_DXGI_FORMAT_BC1_UNORM_SRGB;
		case TIF_DXGI_FORMAT_BC2_UNORM: return TIF_DXGI_FORMAT_BC2_UNORM_SRGB;
		case TIF_DXGI_FORMAT_BC3_UNORM: return TIF_DXGI_FORMAT_BC3_UNORM_SRGB;
		case TIF_DXGI_FORMAT_BC7_UNORM: return TIF_DXGI_FORMAT_BC7_UNORM_SRGB;
		case TIF_DXGI_FORMAT_R8G8B8A8_UNORM: return TIF_DXGI_FORMAT_R8G8B8A8_UNORM_SRGB;
		case TIF_DXGI_FORMAT_B8G8R8A8_UNORM: return TIF_DXGI_FORMAT_B8G8R8A8_UNORM_SRGB;
		case TIF_DXGI_FORMAT_B8G8R8X8_UNORM: return TIF_DXGI_FORMAT_B8G8R8X8_UNORM_SRGB;
		default:
			return pixelFmt;
		}
	}
