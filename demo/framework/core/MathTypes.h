...
namespace math {
    ...
    inline const mat4 perspective(float fovyRadians, float aspect, float zNear, float zFar, bool invertedDepth)
    {
        if (invertedDepth)
        {
    ...
    inline const mat4 orthographic(float left, float right, float bottom, float top, float zNear, float zFar, bool invertedDepth)
    {
