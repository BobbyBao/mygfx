...
namespace mygfx
{
	...
	public:
        ...
        // thread safe
        uint64_t Submit(const std::vector<CommandBuffer>& cmdLists, const VkSemaphore signalSemaphore, const VkSemaphore waitSemaphore, bool useEndOfFrameSemaphore);
        uint64_t Submit(const VkCommandBuffer* cmdLists, uint32_t count, const VkSemaphore signalSemaphore, const VkSemaphore waitSemaphore, bool useEndOfFrameSemaphore);
