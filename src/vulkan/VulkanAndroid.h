...
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "PhantomEngine", __VA_ARGS__))
#define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, "PhantomEngine", __VA_ARGS__))
#define LOGD(...) ((void)__android_log_print(ANDROID_LOG_DEBUG, "PhantomEngine", __VA_ARGS__))
#define LOGE(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "PhantomEngine", __VA_ARGS__))
